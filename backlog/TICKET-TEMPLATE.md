...
Use this for every slice published by `backlog spec`. It doubles as a durable spec for AFK agents — file paths and line numbers go stale; types and behavior contracts don't.

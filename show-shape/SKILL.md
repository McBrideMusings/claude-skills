...
An **option set** — a list choosing between courses of action — is not a plan. [`../CHAT-FORMAT.md`](../CHAT-FORMAT.md) §Option set and §Slate row own that format: numbered question, bolded `1A` / `1B` option lines, bullets, cost last.

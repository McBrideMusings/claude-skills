...
- **Secrets** — a hardcoded credential/key/token, a secret logged or returned in a response/error, or a secret written into a committed file (cross-check the CLAUDE.md no-secrets-in-git rule).

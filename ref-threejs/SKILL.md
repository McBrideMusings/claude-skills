...
| Open | When |
| --- | --- |
| [`../_domains/threejs/context.md`](../_domains/threejs/context.md) | The whole cell — open before writing, debugging or reviewing 3D scene code. |
...
| [`../_domains/threejs/testing.md`](../_domains/threejs/testing.md) | Testing scene code. |

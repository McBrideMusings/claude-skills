---
name: ref-game
description: Game development — game feel, playable loop, fixed timestep, prototyping, tuning, profiling. Load before designing, building or reviewing game mechanics.
---

# Game knowledge

Reference only. The end-to-end build workflow is the [`game-dev`](../game-dev/SKILL.md) skill.

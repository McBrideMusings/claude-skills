...
- **One question per message.** No batching. If a topic needs more, that's more turns.
...
- Durable product spec → `docs/PRD.md` in the repo (or invoke `/docs` to synthesize a full PRD from the conversation)

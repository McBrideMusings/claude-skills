---
name: radarr
description: "Query Radarr to discover movies with file paths and metadata. Formats results as etv-station channel TOML items."
user_invocable: true
---
...
Shape each result into `[[rule.items]]` blocks using the field mapping table. Skip any movie where `hasFile` is false.
...
## Field mapping: Radarr → etv-station TOML

| Radarr API field | TOML field | Notes |
|---|---|---|

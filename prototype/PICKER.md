...
Copied verbatim from emilkowalski/skills `prototype/PICKER.md` (MIT, © 2026 Emil Kowalski). Keep it
verbatim on updates — the point of the file is that it is a fixed spec, not a starting point.

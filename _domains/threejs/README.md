...
The WebGL-stack label under `_domains/`. These four cells cover the three.js / WebGL
...
is **not** here. It lives in the `game` label under `_domains/game/`, stacked alongside

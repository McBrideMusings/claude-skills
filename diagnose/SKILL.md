...
**Then ask: what would have prevented this bug?** If the answer is architectural (no good test seam, tangled callers, hidden coupling), invoke `/improve architecture` with specifics. Make the recommendation **after** the fix — you have more information now than when you started.
